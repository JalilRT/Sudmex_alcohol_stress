...
setwd("/scratch/m/mchakrav/jrasgado/sudmex_alc_stress/analysis/fmri/NBR")

file.copy(from="/scratch/m/mchakrav/jrasgado/sudmex_alc_stress/analysis/smri/DBM_invivo/DBM/data/DBM_dataset.csv", 
	  to=getwd(), 
