...
cat << EOF > ${path}/code/LME_SB/models/M4HL_${rois}.sh
#!/bin/bash
#SBATCH --time=03:30:00
#SBATCH --nodes=1
#SBATCH --ntasks=80
...
singularity exec -B /scratch:/scratch ${container} \
 3dLMEr -prefix /scratch/m/mchakrav/jrasgado/sudmex_alcohol_rat/analysis/fmri/Seed_based/models/M4HL_${rois}.nii.gz -jobs 1 \
