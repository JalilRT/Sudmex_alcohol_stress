...
vector_x=$(cut -d ',' -f 4 ${path}/smri/DBM_invivo/DBM/Trayectories/ROIs.csv)
vector_y=$(cut -d ',' -f 5 ${path}/smri/DBM_invivo/DBM/Trayectories/ROIs.csv)
vector_z=$(cut -d ',' -f 6 ${path}/smri/DBM_invivo/DBM/Trayectories/ROIs.csv)
vector_names=$(cut -d ',' -f 11 ${path}/smri/DBM_invivo/DBM/Trayectories/ROIs.csv)

nrow=$(cat ${path}/smri/DBM_invivo/DBM/Trayectories/ROIs.csv | wc -l)
